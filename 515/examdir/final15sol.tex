...
\end{enumerate}
%   random time $\tau$
%   where $\tau \sim $Gamma($\alpha,\beta$), and find that $w$ of the
%   lightbulbs are still working. What is the {\it total} expected
%   lifetime of just these $w$ bulbs ? % NEED TO FIX THIS! TOO DIFFICULT RIGHT NOW!
