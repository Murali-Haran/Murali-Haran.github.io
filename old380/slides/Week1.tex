...
\begin{center}
    {{\resizebox*{1.1\textwidth}{1.1\textheight}
        {\rotatebox{0}{\includegraphics{trafficI80.pdf}}}} \par}
  \end{center}
\end{frame}
...
\begin{center}
    {{\resizebox*{1.1\textwidth}{1.1\textheight}
        {\rotatebox{0}{\includegraphics{Earthquake.pdf}}}} \par}
  \end{center}
\end{frame}
\begin{frame}%{Text}
...
\begin{center}
    {{\resizebox*{1.1\textwidth}{1.1\textheight}
        {\rotatebox{0}{\includegraphics{Text.pdf}}}} \par}
  \end{center}
\end{frame}
\begin{frame}%{Graph}
...
\begin{center}
    {{\resizebox*{1.1\textwidth}{1.1\textheight}
        {\rotatebox{0}{\includegraphics{Graph.pdf}}}} \par}
  \end{center}
\end{frame}
...
\begin{center}
    {{\resizebox*{1.1\textwidth}{1.1\textheight}
        {\rotatebox{0}{\includegraphics{Metadata.pdf}}}} \par}
  \end{center}
\end{frame}
\begin{frame}%{Image}
...
\begin{center}
    {{\resizebox*{1.1\textwidth}{1.1\textheight}
        {\rotatebox{0}{\includegraphics{Image.pdf}}}} \par}
  \end{center}
\end{frame}
